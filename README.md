...
this is mostly a placeholder, if i ever learn how coding works, i will make a preppy layout

—

PONY TOWN STUFF ONLY OKAY? OKAY.
...
my friend reqs are off, so if you want to friend me, PLEASE whisper me or just ask in general, i'll often say yes if i get to know you first. i don't like random friend reqs tho :/

lastly, we (yes, we) are a bunch of 10 copinglinks that behaves differently! how to know? via the c'link written in some of the skins. the only exception is boombox but that's because he's the most active on ponytown. if you wish to see every copinglinks' own boundaries, feel free to check the pronouns.cc page!

-- 2 ; __BEFORE INTERACTING__ :
...
basic dni list, so like anyone that is racist, homophobic, pedos ect..

please know that IM AN ADULT, so anyone under 14, please don't interact further, for both of our sake (also because i don't like PT children).
